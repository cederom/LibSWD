...
**HAVE YOU SEEN THE [ARM mbed DAPLink](https://github.com/mbedmicro/DAPLink) PROJECT? ITS AN OPEN-SOURCE FIRMWARE THAT CAN CONVERT TINY ARM MCU INTO USB HARDWARE DEBUGGER FOR RAPID DRAG-N-DROP FLASHING, HID/CMSIS-DAP DEBUG (WORKS BEST WITH [pyOCD](https://github.com/mbedmicro/pyocd)), AND VIRTUAL COM PORT UART CONNECTED TO YOUR TARGET! I AM DEVELOPING THAT PROJECT AS WELL, PLEASE GIVE IT A TRY, YOU WILL GET EFFICIENT AND EASY SOLUTION TO DEVELOP YOUR DESING! :-)**
